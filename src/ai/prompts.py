...
- "Кто номинирован на Оскар?" → `web_search("Oscar 2026 nominations")`
- "Что снимает Джармуш?" → `web_search("Jim Jarmusch new film 2025 2026")`
- "Когда выходит Dune 3?" → `web_search("Dune 3 release date")`
